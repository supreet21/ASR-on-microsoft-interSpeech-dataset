...
if [ $stage -le 2 ]; then
utils/utt2spk_to_spk2utt.pl data/telugu_train/utt2spk > data/telugu_train/spk2utt
utils/utt2spk_to_spk2utt.pl data/telugu_test/utt2spk > data/telugu_test/spk2utt
fi
...
if [ $stage -le 3 ]; then
  ...
  local/prepare_lm.sh 2 data/local/lm.gz
  local/prepare_lm.sh 3 data/local/lm_tglarge.arpa.gz
  local/prepare_lm.sh 4 data/local/lm_fglarge.arpa.gz
  utils/prepare_lang.sh data/local/dict_nosp \
   "<UNK>" data/local/lang_tmp_nosp data/lang
utils/format_lm.sh data/lang data/local/lm.gz data/local/dict_nosp/lexicon.txt data/lang_nosp

 # local/format_lms.sh --src-dir data/lang_nosp data/local/lm.gz
fi

if [ $stage -le 4 ]; then
  # Create ConstArpaLm format language model for full 3-gram and 4-gram LMs
  utils/build_const_arpa_lm.sh data/local/lm_tglarge.arpa.gz \
    data/lang_nosp data/lang_nosp_test_tglarge
  utils/build_const_arpa_lm.sh data/local/lm_fglarge.arpa.gz \
